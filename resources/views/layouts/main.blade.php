                ...
                <div class="list-group list-group-flush">
                    ...
                    @elseif (auth()->user()->peran === 'guru')
                        <a href="/guru/dashboard"
                            class="border rounded py-3 d-flex align-items-center justify-content-between small bg-primary-light text-primary-dark false list-group-item {{ Route::is('dashboard.guru') ? 'active' : '' }}">
                            <span><i class="bi bi-speedometer"></i> Dashboard</span></a>
                    @else
                    ...
                    @if (auth()->user()->peran == 'siswa')
                        <a href="/kelas"
                            class="border rounded py-3 d-flex align-items-center justify-content-between small bg-primary-light text-primary-dark false list-group-item {{ Route::is('kelas.index') ? 'active' : '' }}">
                    ...
                    @if (auth()->user()->peran == 'guru')
                        ...
                        <a href="/dataKelompok"
                            class="border rounded py-3 d-flex align-items-center justify-content-between small bg-primary-light text-primary-dark false list-group-item {{ Route::is('dataKelompok') || Route::is('datakelompok') ? 'active' : '' }}">
                            <span><i class="bi bi-journal-text"></i> Data Kelompok</span></a>
                    @endif
