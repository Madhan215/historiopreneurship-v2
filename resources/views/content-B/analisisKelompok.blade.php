...
@section('container-content')
    ...
    <p>
        Berdasarkan hasil identifikasi terkait objek kesejarahan yang ada di daerah kalian, petakanlah objek-objek
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="ratio ratio-16x9 shadow">
                    <iframe src="https://www.youtube.com/embed/P4B-OnP8ISc?si=YBNeIwxF_qJmlo3E" title="YouTube video player"
            ...
            @foreach (range(1, 10) as $i)
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <input name="objek{{ $i }}" id="objek{{ $i }}" rows="5" class="form-control"
                            value="{{ old('objek' . $i, $jawabanValue) }}" {{ $isDisabled ? 'disabled' : '' }}>
                ...
                <div class="card-body mt-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control" name="nilai_akhir" min="0" max="100"
                            value="{{ $nilaiJawabanIndividuKesejarahan->nilai_akhir ?? '' }}" readonly>
                    </div>
                    ...
                    <textarea class="form-control w-100 mt-2" name="data_jawaban_penilai" id="feedbackIndividu" rows="5"
                        readonly>{{ $nilaiJawabanIndividuKesejarahan->data_jawaban_penilai ?? '' }}</textarea>
                </div>
