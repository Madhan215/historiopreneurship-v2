            ...
            <div class="col">
                    ...
                    @for ($i = 1; $i <= $maxKelompokId; $i++)
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="kelompok{{ $i }}-tab" data-bs-toggle="tab"
                                data-bs-target="#kelompok{{ $i }}" type="button" role="tab"
                                aria-controls="kelompok{{ $i }}" aria-selected="false">Kelompok
                                {{ $i }}</button>
                        </li>
                    @endfor
                </ul>
                ...
                <div class="tab-content mt-3" id="myTabContent">
                                            ...
                                            @else
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        @for ($i = 1; $i <= 4; $i++)
                                                            <li>
                                                                <form action="{{ route('dataMahasiswa.saveGroup') }}"
                    ...
                    @for ($i = 1; $i <= $maxKelompokId; $i++)
                        ...
                        @endphp
                        <div class="tab-pane fade" id="kelompok{{ $i }}" role="tabpanel"
                            aria-labelledby="kelompok{{ $i }}-tab">
                            <h4>Kelompok {{ $i }}</h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            @for ($j = 1; $j <= $maxKelompokId; $j++)
                                                                @if ($j != $i)
                                                                    <!-- Hindari menugaskan ke kelompok saat ini -->
                                                                    <li>
                                                                        <form
                                                                            action="{{ route('dataMahasiswa.saveGroup') }}"
                                                                            method="POST" style="display: inline;">
                                                                            @csrf
                                                                            <input type="hidden" name="email"
                                                                                value="{{ $Mahasiswa->email }}">
                                                    ...
                                                    <div class="btn-group ms-2" role="group">
                                                        ...
                                                        <form action="{{ route('dataMahasiswa.removeFromGroup') }}"
                                                            method="POST" style="display: inline;">
                                                            @csrf
                                                            <input type="hidden" name="email"
                                                                value="{{ $Mahasiswa->email }}">
