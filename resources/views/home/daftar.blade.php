    ...
    <div class="p-5 p-sm-5 mb-5 mb-sm-0 flex-grow-1 container">
        <div class="d-md-flex gap-5 align-items-center">
            ...
            <form class="w-100" action="{{ route('register.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="nama-lengkap" class="form-label fw-semibold" value="{{ old('namaInput') }}">Nama
                        Lengkap</label>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" name="passwordInput" placeholder="Password" class="form-control"
                ...
                {{-- <div class="mb-3" id="class_token_div" style="display: none">
                    ...
                    <input type="text" name="token" placeholder="Token Kelas" class="form-control">
                </div> --}}
                <div class="mt-4">
