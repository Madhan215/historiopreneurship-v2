        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            {{-- <li class="nav-item" role="presentation">
                <button class="nav-link" id="kesejarahan-ii-tab" data-bs-toggle="tab" data-bs-target="#kesejarahan-ii"
                    type="button" role="tab" aria-controls="kesejarahan-ii" aria-selected="false">Analisis Kelompok
                    Kesejarahan</button>
            </li>
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="file-upload-tab" data-bs-toggle="tab" data-bs-target="#file-upload"
                    type="button" role="tab" aria-controls="file-upload" aria-selected="true">File Upload</button>
            </li>
        </ul>
        ...
        <div class="tab-content" id="myTabContent">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('kirimJawabanIndividu', ['email' => $email]) }}" method="POST">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" name="nilai_akhir" min="0"
                                                max="100" required aria-label="Sizing example input"
                                                aria-describedby="inputGroup-sizing-sm"
                                                value="{{ $nilaiAnalisisIndividuKesejarahan_II->nilai_akhir ?? '' }}"
                                                {{ $nilaiAnalisisIndividuKesejarahan_II ? 'disabled' : '' }}>
                                        </div>
                                        ...
                                        <textarea class="form-control w-100 mt-2" name="data_jawaban_penilai" id="feedbackIndividu" rows="5"
                                            {{ $nilaiAnalisisIndividuKesejarahan_II ? 'disabled' : '' }}>{{ $nilaiAnalisisIndividuKesejarahan_II->data_jawaban_penilai ?? '' }}</textarea>
                                    ...
                                    <form action="{{ route('kirimJawabanIndividu', ['email' => $email]) }}" method="POST">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" name="nilai_akhir" min="0"
                                                max="100" required aria-label="Sizing example input"
                                                aria-describedby="inputGroup-sizing-sm"
                                                value="{{ $nilaiAnalisisIndividuKesejarahan->nilai_akhir ?? '' }}"
                                                {{ $nilaiAnalisisIndividuKesejarahan ? 'disabled' : '' }}>
                                        </div>
                                        <label for="feedbackIndividu">Feedback</label><br>
                                        <textarea class="form-control w-100 mt-2" name="data_jawaban_penilai" id="feedbackIndividu" rows="5"
                                            {{ $nilaiAnalisisIndividuKesejarahan ? 'disabled' : '' }}>{{ $nilaiAnalisisIndividuKesejarahan->data_jawaban_penilai ?? '' }}</textarea>
                                        <button type="submit" class="btn btn-primary mt-3">Kirim</button>
                                    </form>
                                </div>
                                <div class="card-footer text-muted">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('kirimJawabanIndividu', ['email' => $email]) }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" name="nilai_akhir" min="0"
                                                max="100" required aria-label="Sizing example input"
                                                aria-describedby="inputGroup-sizing-sm"
                                                value="{{ $nilaiAnalisisIndividuKWU->nilai_akhir ?? '' }}"
                                                {{ $nilaiAnalisisIndividuKWU ? 'disabled' : '' }}>
                                        </div>
                                        <label for="feedbackIndividu">Feedback</label><br>
                                        <textarea class="form-control w-100 mt-2" name="data_jawaban_penilai" id="feedbackIndividu" rows="5"
                                            {{ $nilaiAnalisisIndividuKWU ? 'disabled' : '' }}>{{ $nilaiAnalisisIndividuKWU->data_jawaban_penilai ?? '' }}</textarea>
                                        <button type="submit" class="btn btn-primary mt-3">Kirim</button>
                                    </form>
                                </div>
                                <div class="card-footer text-muted">
            ...
            <div class="tab-pane fade show active" id="file-upload" role="tabpanel" aria-labelledby="file-upload-tab">
                ...
                @else
                            ...
                            @foreach ($fileUploads as $index => $file)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal Nilai-->
                                        <div class="modal fade" id="nilai{{ $index }}" tabindex="-1"
                                            aria-labelledby="nilaiLabel{{ $index }}" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        {{-- Edit full disini --}}
                                                        <form
                                                            action="{{ route('kirimJawabanIndividu', ['email' => $email]) }}"
                                                            method="POST">
                                                            @csrf
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    name="nilai_akhir" min="0" max="100"
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-primary btn-sm mt-3">Kirim</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    @php
                        $hasKegiatanPembelajaran3 = collect($fileUploads)->contains(
                            'kategori',
                                        ...
                                        <form action="{{ route('kirimJawabanIndividu', ['email' => $email]) }}"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" class="form-control" name="nilai_akhir"
                                                    ...
                                                    aria-label="Sizing example input"
                                                    aria-describedby="inputGroup-sizing-sm"
                                                    value="{{ $nilaiUploadAktivitas1->nilai_akhir ?? '' }}"
                                                    {{ $nilaiUploadAktivitas1 ? 'disabled' : '' }}>
                                            </div>
                                            <label for="feedbackIndividu">Feedback</label><br>
                                            <textarea class="form-control w-100 mt-2" name="data_jawaban_penilai" id="feedbackIndividu" rows="5"
                                                {{ $nilaiUploadAktivitas1 ? 'disabled' : '' }}>
                                        ...
                                        <form action="{{ route('kirimJawabanIndividu', ['email' => $email]) }}"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" class="form-control" name="nilai_akhir"
                                                    ...
                                                    aria-label="Sizing example input"
                                                    aria-describedby="inputGroup-sizing-sm"
                                                    value="{{ $nilaiUploadAktivitas2->nilai_akhir ?? '' }}"
                                                    {{ $nilaiUploadAktivitas2 ? 'disabled' : '' }}>
                                            </div>
                                            <label for="feedbackIndividu">Feedback</label><br>
                                            <textarea class="form-control w-100 mt-2" name="data_jawaban_penilai" id="feedbackIndividu" rows="5"
                                                {{ $nilaiUploadAktivitas2 ? 'disabled' : '' }}>
                                        ...
                                        <form action="{{ route('kirimJawabanIndividu', ['email' => $email]) }}"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" class="form-control" name="nilai_akhir"
                                                    ...
                                                    aria-label="Sizing example input"
                                                    aria-describedby="inputGroup-sizing-sm"
                                                    value="{{ $nilaiUploadProyekIndividu->nilai_akhir ?? '' }}"
                                                    {{ $nilaiUploadProyekIndividu ? 'disabled' : '' }}>
                                            </div>
                                            <label for="feedbackIndividu">Feedback</label><br>
                                            <textarea class="form-control w-100 mt-2" name="data_jawaban_penilai" id="feedbackIndividu" rows="5"
                                                {{ $nilaiUploadProyekIndividu ? 'disabled' : '' }}>
